...
import { HomepagePreview } from "../style/edithomepage.style";
...
function PixelVaultEdithero(props) {
  const {
    handleNext,
    homeLogo,
    setHomeLogo,
                ...
                >
                  ...
                  <defs>
                    ...
                    >
                      ...
                      <stop offset="1" stop-color={blur2} stop-opacity="0" />
                    </linearGradient>
                  </defs>
                </svg>
                <svg
...
export default PixelVaultEdithero;
